---
title: 'Crêpe Complète with Panko-Crusted Ham'
description: 'A French bistro classic with ham, egg, and melted Gruyère inside a golden crepe, elevated with a crispy panko crust on the ham.'
serves: 2
prepTime: '15 min'
cookTime: '15 min'
inactiveTime: '30 min (rest)'
...
ingredients:
  ...
  - title: Filling
  - name: 'thick-cut Black Forest ham slices'
    quantity: 4
    unit: ''
  - name: 'panko breadcrumbs'
    quantity: 0.5
    unit: 'cup'
  - name: 'butter, for frying ham'
    quantity: 2
    unit: 'Tbsp'
  - name: 'Gruyère or Swiss cheese, shredded'
    quantity: 0.5
    unit: 'cup'
  - name: 'Dijon mustard'
    quantity: 1
